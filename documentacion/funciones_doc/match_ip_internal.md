# Determinar si alguna IP es interna consultado una base de datos de activos
...
Esta funcion recibe un JSON con los campos source_ip y destination_ip y determina
cual de estas IPs pertenece a la Red de la Universidad de Cordoba y cual es externa.
El inventario de IPs internas se obtiene consultado una base wiki.

La URL de la base wiki se define en `activosPSI`. 



## Codigo en Python 

`match_IP_internal.py`
